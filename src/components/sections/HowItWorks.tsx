...
const STEPS = [
  {
    ...
    body: "Choose in-person at Paras Health Kanpur (Mon–Sat) or one of the Lucknow clinics on Wednesday. Consultation fee ₹1,000. Most patients get an appointment within the same week.",
    color: "#E8714A",
    bg: "#FFF4EE",
  },
  {
